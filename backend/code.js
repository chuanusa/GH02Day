...
// ============================================
function doGet(e) {
  if (!e.parameter.api && !e.parameter.type && !e.parameter.action) {
    // Default to JSON API even without params, or return simple message
    return ContentService.createTextOutput("GAS API Service is running. Use ?action=... to access data.")
